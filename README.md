Вот оформленный и красиво структурированный вариант для файла `README.md`. Я сохранил содержание, но добавил оформление в стиле Markdown, заголовки, блоки кода и читаемую структуру:
